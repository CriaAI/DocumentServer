...
exports.USER_ID_MAX_LENGTH = 240;
exports.USER_NAME_MAX_LENGTH = 255;
exports.PASSWORD_MAX_LENGTH = 255;
...
// ── PATCHED: removed connection limit ──
exports.LICENSE_CONNECTIONS = 99999;
exports.LICENSE_USERS = 99999;
exports.LICENSE_EXPIRE_USERS_ONE_DAY = 24 * 60 * 60;
...
exports.AVS_OFFICESTUDIO_FILE_OTHER_JSON = exports.AVS_OFFICESTUDIO_FILE_OTHER + 0x0008;
...
exports.QUIET_CODE = 4011;
exports.QUIET = 'quiet';
exports.RECONNECT_FAILED_CODE = 4012;
...
exports.TABLE_RESULT_SCHEMA = [
  'tenant', 'id', 'status', 'status_info', 'created_at', 'last_open_date',
  'user_index', 'change_id', 'callback', 'baseurl', 'password', 'additional'
];
exports.TABLE_CHANGES_SCHEMA = [
  'tenant', 'id', 'change_id', 'user_id', 'user_id_original', 'user_name',
